...
class _ResetPasswordWidgetState extends State<ResetPasswordWidget> {
  ...
  void initState() {
    ...
    _model.createFocusNode ??= FocusNode();
                    ...
                    children: [
                      ...
                      Padding(
                        ...
                        child: InkWell(
                          ...
                          onTap: () async {
                            logFirebaseEvent(
                                'RESET_PASSWORD_Column_jm3o1cmq_ON_TAP');
                            logFirebaseEvent('Column_auth');
                            await authManager.updatePassword(
                              newPassword: _model.createTextController.text,
                              context: context,
                            );
                            safeSetState(() {});
                            ...
                            children: [
                              Container(
                                ...
                                child: TextFormField(
                                  ...
                                  focusNode: _model.createFocusNode,
                                  autofocus: false,
                                  obscureText: !_model.createVisibility,
                                ...
                                children: [
                                  Padding(
                                    ...
                                    child: FFButtonWidget(
                                      onPressed: () async {
                                        logFirebaseEvent(
                                            'RESET_PASSWORD_PAGE_UPDATE_BTN_ON_TAP');
