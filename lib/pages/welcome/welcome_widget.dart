                        ...
                        child: Column(
                          ...
                          children: [
                            ...
                            InkWell(
                              ...
                              onTap: () async {
                                logFirebaseEvent(
                                    'WELCOME_PAGE_Text_c4dlu8xf_ON_TAP');
                                  ...
                                  children: [
                                    TextSpan(
                                      ...
                                      recognizer: TapGestureRecognizer()
                                        ..onTap = () async {
                                          logFirebaseEvent(
                                              'WELCOME_RichTextSpan_yyc9wlsy_ON_TAP');
                                          logFirebaseEvent(
                            ...
                            Column(
                              ...
                              children: [
                                  ...
                                  onPressed: () async {
                                    ...
                                    if (widget.to) {
                                      ...
                                      context.pushNamedAuth(
                                          KtmCreateTournamentWidget.routeName,
                                          context.mounted);
                                    } else {
                                      logFirebaseEvent('Button_navigate_to');
                                ...
                                FFButtonWidget(
                                  onPressed: () async {
                                    logFirebaseEvent(
                                        'WELCOME_LOG_IN_USING_GOOGLE_BTN_ON_TAP');
                                    logFirebaseEvent('Button_auth');
                                    GoRouter.of(context).prepareAuthEvent();
                                ...
                                FFButtonWidget(
                                  onPressed: () async {
                                    logFirebaseEvent(
                                        'WELCOME_SIGN_UP_USING_GOOGLE_BTN_ON_TAP');
                                    logFirebaseEvent('Button_auth');
                                    GoRouter.of(context).prepareAuthEvent();
                                    final user = await authManager
                                        .signInWithGoogle(context);
                                ...
                                Padding(
                                  ...
                                  child: FFButtonWidget(
                                    onPressed: () async {
                                      logFirebaseEvent(
                                          'WELCOME_CREATE_A_NEW_ACCOUNT_BTN_ON_TAP');
                                      logFirebaseEvent('Button_navigate_to');
                          ...
                          child: Column(
                            ...
                            children: [
                              InkWell(
                                ...
                                onTap: () async {
                                  logFirebaseEvent(
                                      'WELCOME_PAGE_RichText_z7s3ftk9_ON_TAP');
                              ...
                              InkWell(
                                ...
                                onTap: () async {
                                  logFirebaseEvent(
                                      'WELCOME_PAGE_RichText_46hrf0ht_ON_TAP');
                                  logFirebaseEvent('RichText_navigate_to');
                              ...
                              InkWell(
                                ...
                                onTap: () async {
                                  logFirebaseEvent(
                                      'WELCOME_PAGE_RichText_gr2v48c0_ON_TAP');
                                  logFirebaseEvent('RichText_navigate_to');
                              ...
                              InkWell(
                                ...
                                onTap: () async {
                                  logFirebaseEvent(
                                      'WELCOME_PAGE_RichText_w1nor855_ON_TAP');
                                  logFirebaseEvent('RichText_navigate_to');

                                  context
                                      .pushNamed(RefundPolicyWidget.routeName);
                                },
                                child: RichText(
                                  textScaler: MediaQuery.of(context).textScaler,
                                  text: TextSpan(
