            ...
            child: Padding(
              ...
              child: Column(
                ...
                children: [
                  Row(
                    ...
                    children: [
                      ...
                      InkWell(
                        ...
                        onTap: () async {
                          logFirebaseEvent(
                              'EVENT_ADD_COMP_Icon_penk61yn_ON_TAP');
                  ...
                  Stack(
                    children: [
                      if (_model.mediaUrl != null && _model.mediaUrl != '')
                        InkWell(
                          splashColor: Colors.transparent,
                          focusColor: Colors.transparent,
                          hoverColor: Colors.transparent,
                          ...
                          onTap: () async {
                            logFirebaseEvent(
                                'EVENT_ADD_COMP_Image_eab0yhf3_ON_TAP');
                            logFirebaseEvent('Image_delete_data');
                            await deleteSupabaseFileFromPublicUrl(
                                _model.mediaUrl!);
                            logFirebaseEvent('Image_upload_media_to_supabase');
                            ...
                            if (selectedMedia != null &&
                              ...
                              safeSetState(
                                  () => _model.isDataUploading_imageUrl = true);
                              ...
                              try {
                                ...
                                _model.isDataUploading_imageUrl = false;
                              }
                            ...
                            logFirebaseEvent('Image_update_component_state');
                            _model.mediaUrl = _model.uploadedFileUrl_imageUrl;
                            safeSetState(() {});
                          },
                          child: ClipRRect(
                      ...
                      if (_model.mediaUrl == null || _model.mediaUrl == '')
                        Align(
                          ...
                          child: InkWell(
                            ...
                            onTap: () async {
                              logFirebaseEvent(
                                  'EVENT_ADD_COMP_Container_pef6l953_ON_TAP');
                              logFirebaseEvent(
                              ...
                              if (selectedMedia != null &&
                                  selectedMedia.every((m) => validateFileFormat(
                                      m.storagePath, context))) {
                                safeSetState(() =>
                                    _model.isDataUploading_imageUr = true);
                                var selectedUploadedFiles = <FFUploadedFile>[];
                                ...
                                try {
                                  ...
                                  _model.isDataUploading_imageUr = false;
                                }
                                if (selectedUploadedFiles.length ==
                                        selectedMedia.length &&
                                    downloadUrls.length ==
                                        selectedMedia.length) {
                                  safeSetState(() {
                                    _model.uploadedLocalFile_imageUr =
                                        selectedUploadedFiles.first;
                                    _model.uploadedFileUrl_imageUr =
                                        downloadUrls.first;
                                  });
                                } else {
                                  safeSetState(() {});
                              ...
                              _model.mediaUrl = _model.uploadedFileUrl_imageUr;
                              safeSetState(() {});
                            },
                            child: Container(
                    ...
                    children: [
                      Expanded(
                        child: InkWell(
                          ...
                          onTap: () async {
                            logFirebaseEvent(
                                'EVENT_ADD_COMP_Container_v83qcnzf_ON_TAP');
                      ...
                      Expanded(
                        child: InkWell(
                          ...
                          onTap: () async {
                            logFirebaseEvent(
                                'EVENT_ADD_COMP_Container_i71fizht_ON_TAP');
                            logFirebaseEvent('Container_date_time_picker');
                            await showModalBottomSheet<bool>(
                                context: context,
                                builder: (context) {
          ...
          Align(
            ...
            child: Padding(
              ...
              child: FFButtonWidget(
                onPressed: () async {
                  logFirebaseEvent('EVENT_ADD_COMP_SAVE_BTN_ON_TAP');
                  logFirebaseEvent('Button_bottom_sheet');
                  Navigator.pop(
                      context,
                      EventDetailsStruct(
                        imageUrl: _model.mediaUrl,
                        eventName: _model.otpInputTextController1.text,
                        audience: _model.choiceChipsValues,
                        date: dateTimeFormat(
                          "d/M/y",
                          _model.datePicked1,
                        ...
                        description: _model.otpInputTextController2.text,
                      ));
                },
                text: 'Save',
