...
import 'package:kickin/l10n/arb/app_localizations_en.dart';
import 'package:path_provider/path_provider.dart';
import 'package:persistent_storage/persistent_storage.dart';
import 'package:powersync_repository/powersync_repository.dart'; // Corrected the path here
import 'package:shared/shared.dart';
import 'package:shared_preferences/shared_preferences.dart'; // Added the correct import
  ...
  await runZonedGuarded(
    () async {
      ...
      final sharedPreferences =
          await SharedPreferences.getInstance(); // Corrected here
