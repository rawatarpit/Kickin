    ...
    switch (paramType) {
      ...
      case ParamType.SupabaseRow:
        ...
        switch (T) {
          ...
          case KickinAdsRow:
            return KickinAdsRow(data);
          case KtmMatchesRow:
            return KtmMatchesRow(data);
